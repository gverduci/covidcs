...
resultsHeader.append([oJsonColumns['columns'][0], oJsonColumns['columns'][1], oJsonColumns['columns'][2], "Attuali ricoverati in rianimazione","Attuali ricoverati in altri reparti","In isolamento domiciliare ultimi 30gg"])

for comune in oJson:
    results.append([comune['columns'][0], comune['columns'][1], comune['columns'][2], "-", "-", "-"])
